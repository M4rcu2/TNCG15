...
public:
    ...
    // Constructor
    Light(const glm::vec3& p1, const glm::vec3& p2, const glm::vec3& p3, const glm::vec3& p4, const glm::vec3& intensity) : surface_(new Rectangle(p1, p2, p3, p4, ColorDBL(intensity.x, intensity.y, intensity.z))), intensity_(intensity) {
